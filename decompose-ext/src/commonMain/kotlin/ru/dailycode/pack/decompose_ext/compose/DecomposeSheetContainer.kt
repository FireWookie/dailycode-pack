...
// */
//@Composable
//internal fun <S : Any> DecomposeSheetContainer(
//    sheetContentComponentState: State<BottomSheetContentComponent<S>?>,
//    onDismiss: () -> Unit,
////    sheetState: DecomposeSheetValue = rememberComponentModalBottomSheetState(sheetContentComponentState),
...
//    val sheetContentSlot: BottomSheetContentComponent<S>? by sheetContentComponentState
//
...
//    var latestChildInstance: BottomSheetContentComponent<S>? by remember {
